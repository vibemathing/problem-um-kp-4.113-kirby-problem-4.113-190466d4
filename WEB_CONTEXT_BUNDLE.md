...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.113-kirby-problem-4.113-190466d4-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.113"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.113-kirby-problem-4.113-190466d4-v1",
      "problem_contract_sha256": "99efedc54b72820dde80442ba32316930b014046938d149024b71c6e088b8bba",
      "problem_id": "problem:um-kp-4.113-kirby-problem-4.113-190466d4",
      "route_id": "route:um-kp-4.113-kirby-problem-4.113-190466d4-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.113-kirby-problem-4.113-190466d4-source-fidelity-01",
      "graph_id": "graph:um-kp-4.113-kirby-problem-4.113-190466d4-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.113-kirby-problem-4.113-190466d4-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.113-kirby-problem-4.113-190466d4-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Which closed, oriented, smooth 4–manifolds admit genus–3 trisections? Which ones admit genus–3 simplified trisections? How about genus–4?"
          },
          "statement_sha256": "c644286b9377c63780ed6adde92550f5e28ee6197c8d6127dc2d2f99f9eda2bb"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.113-kirby-problem-4.113-190466d4-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.113-kirby-problem-4.113-190466d4-root",
      "route_id": "route:um-kp-4.113-kirby-problem-4.113-190466d4-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.113-a89b213fc906",
        "url": "https://www.unsolvedmath.com/problems/KP-4.113"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
